...
func get_deep_composition_coefficients{
    ...
    set_trace_coefficients(
        ...
        n_coefficients= (air.main_segment_width + air.aux_trace_width) * 2, // Why???
    ...
    draw_elements(n_elements=(air.main_segment_width + air.aux_trace_width) , elements=c_coefficients); // Why???
