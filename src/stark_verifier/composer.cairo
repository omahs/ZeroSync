...
func compose_constraint_evaluations{
    ...
    loop:
        ...
        tempvar sum = sum + (row[4] - ood_evaluations.elements[4]) * cc_constraint[0]; 
        tempvar sum = sum + (row[5] - ood_evaluations.elements[5]) * cc_constraint[1]; 
        tempvar sum = sum + (row[6] - ood_evaluations.elements[6]) * cc_constraint[2]; 
        tempvar sum = sum + (row[7] - ood_evaluations.elements[7]) * cc_constraint[3]; 
        tempvar sum = sum + (row[8] - ood_evaluations.elements[8]) * cc_constraint[0]; 
        tempvar sum = sum + (row[9] - ood_evaluations.elements[9]) * cc_constraint[1]; 
        tempvar sum = sum + (row[10] - ood_evaluations.elements[10]) * cc_constraint[2]; 
        tempvar sum = sum + (row[11] - ood_evaluations.elements[11]) * cc_constraint[3]; 
        tempvar sum = sum + (row[12] - ood_evaluations.elements[12]) * cc_constraint[0]; 
        tempvar sum = sum + (row[13] - ood_evaluations.elements[13]) * cc_constraint[1]; 
        tempvar sum = sum + (row[14] - ood_evaluations.elements[14]) * cc_constraint[2]; 
        tempvar sum = sum + (row[15] - ood_evaluations.elements[15]) * cc_constraint[3]; 
        tempvar sum = sum + (row[16] - ood_evaluations.elements[16]) * cc_constraint[0]; 
        tempvar sum = sum + (row[17] - ood_evaluations.elements[17]) * cc_constraint[1]; 
        tempvar sum = sum + (row[18] - ood_evaluations.elements[18]) * cc_constraint[2]; 
        tempvar sum = sum + (row[19] - ood_evaluations.elements[19]) * cc_constraint[3]; 
        tempvar sum = sum + (row[20] - ood_evaluations.elements[20]) * cc_constraint[0]; 
        tempvar sum = sum + (row[21] - ood_evaluations.elements[21]) * cc_constraint[1]; 
        tempvar sum = sum + (row[22] - ood_evaluations.elements[22]) * cc_constraint[2]; 
        tempvar sum = sum + (row[23] - ood_evaluations.elements[23]) * cc_constraint[3]; 
        tempvar sum = sum + (row[24] - ood_evaluations.elements[24]) * cc_constraint[0]; 
        tempvar sum = sum + (row[25] - ood_evaluations.elements[25]) * cc_constraint[1]; 
        tempvar sum = sum + (row[26] - ood_evaluations.elements[26]) * cc_constraint[2]; 
        tempvar sum = sum + (row[27] - ood_evaluations.elements[27]) * cc_constraint[3]; 
        tempvar sum = sum + (row[28] - ood_evaluations.elements[28]) * cc_constraint[0]; 
        tempvar sum = sum + (row[29] - ood_evaluations.elements[29]) * cc_constraint[1]; 
        tempvar sum = sum + (row[30] - ood_evaluations.elements[30]) * cc_constraint[2]; 
        tempvar sum = sum + (row[31] - ood_evaluations.elements[31]) * cc_constraint[3]; 
        tempvar sum = sum + (row[32] - ood_evaluations.elements[32]) * cc_constraint[0]; 
        tempvar sum = sum + (row[33] - ood_evaluations.elements[33]) * cc_constraint[1]; 
        tempvar sum = sum + (row[34] - ood_evaluations.elements[34]) * cc_constraint[2]; 
        tempvar sum = sum + (row[35] - ood_evaluations.elements[35]) * cc_constraint[3]; 
        tempvar sum = sum + (row[36] - ood_evaluations.elements[36]) * cc_constraint[0]; 
        tempvar sum = sum + (row[37] - ood_evaluations.elements[37]) * cc_constraint[1]; 
        tempvar sum = sum + (row[38] - ood_evaluations.elements[38]) * cc_constraint[2]; 
        tempvar sum = sum + (row[39] - ood_evaluations.elements[39]) * cc_constraint[3]; 
        tempvar sum = sum + (row[40] - ood_evaluations.elements[40]) * cc_constraint[0]; 
        tempvar sum = sum + (row[41] - ood_evaluations.elements[41]) * cc_constraint[1]; 
        tempvar sum = sum + (row[42] - ood_evaluations.elements[42]) * cc_constraint[2]; 
        tempvar sum = sum + (row[43] - ood_evaluations.elements[43]) * cc_constraint[3]; 
        tempvar sum = sum + (row[44] - ood_evaluations.elements[44]) * cc_constraint[0]; 
        tempvar sum = sum + (row[45] - ood_evaluations.elements[45]) * cc_constraint[1]; 
        tempvar sum = sum + (row[46] - ood_evaluations.elements[46]) * cc_constraint[2]; 
        tempvar sum = sum + (row[47] - ood_evaluations.elements[47]) * cc_constraint[3]; 
        tempvar sum = sum + (row[48] - ood_evaluations.elements[48]) * cc_constraint[0]; 
        tempvar x = [x_coord_ptr];
